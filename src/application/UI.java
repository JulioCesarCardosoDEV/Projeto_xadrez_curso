...
public class UI {
	...
	// Cores importadas do stackoverflow
	...
	// Método que limpa o console, diminuindo a poluição visual
	...
	private static void printPiece(ChessPiece piece, boolean background) {
		// Cor azul para as jogadas possiveis de realizar
		if(background) {
		...
		// Senão, se existir peça no local, imprima a peça
			...
			if(piece.getColor() == Color.WHITE) {
				...
				// Amarelo representa as peças pretas
	...
	// Lista vai receber a entrada de peças e se forem peças brancas, serão coletadas
